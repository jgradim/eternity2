...
\begin{figure}[H]
  \centering
  \subfloat[7x7]{\label{fig:fitness_evolution_7x7}\includegraphics[width=70mm]{images/fitness_evolution_7x7.png}}
  \subfloat[10x10]{\label{fig:fitness_evolution_10x10}\includegraphics[width=70mm]{images/fitness_evolution_10x10.png}}
  \hspace{40mm}
  \subfloat[11x11]{\label{fig:fitness_evolution_11x11}\includegraphics[width=70mm]{images/fitness_evolution_11x11.png}}
  \caption{Initial population tests with a board with 7 by 7 tiles, 6 patterns}
  \label{fig:population_stats}
\end{figure}
