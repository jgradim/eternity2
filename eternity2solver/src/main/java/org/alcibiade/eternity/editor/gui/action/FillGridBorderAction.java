...
public class FillGridBorderAction extends GridUpdateAction {
	private static final long serialVersionUID = 1L;
	private GridModel gridModel;
	private int patterns;

	public FillGridBorderAction(GridModel grid, int patterns, EditableStatusProvider editable) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		filler.FillBorderRandom(patterns);
	}
