...
public class DumbSolverNew extends SwappingSolver {

	public DumbSolverNew(GridModel grid, GridModel solution_grid, ClusterManager clusterManager) {
		super(grid, solution_grid, clusterManager);
	}

	@Override
	public String getSolverName() {
		return "Dumb Solver New $Revision: testetesteteste $";
	}
